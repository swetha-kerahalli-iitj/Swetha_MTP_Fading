...
def get_args():
    ...
    parser.add_argument('-BASE_PATH', default=r'C:\WorkSpace\FadingChannels\turboae')
    parser.add_argument('-LOG_PATH', default=os.path.join(r'C:\WorkSpace\FadingChannels\turboae',
                                                          time.strftime('%Y%m%d_%H%M%S', time.localtime()),
                                                          r'logs_faded'))
    parser.add_argument('-DATA_PATH', default=os.path.join(r'C:\WorkSpace\FadingChannels\turboae',
                                                           time.strftime('%Y%m%d_%H%M%S', time.localtime()),
                                                           r'data_faded'))
    parser.add_argument('-MODEL_PATH', default=os.path.join(r'C:\WorkSpace\FadingChannels\turboae',
                                                            time.strftime('%Y%m%d_%H%M%S', time.localtime()),
                                                            r'model_faded'))
    parser.add_argument('-PLOT_PATH', default=os.path.join(r'C:\WorkSpace\FadingChannels\turboae',
                                                           time.strftime('%Y%m%d_%H%M%S', time.localtime()),
                                                           r'plot_faded'))
